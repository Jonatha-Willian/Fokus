...
const removerTarefas = (somenteConpletas) => {
    const seletor = somenteConpletas ? ".app__section-task-list-item-complete" : ".app__section-task-list-item"
    document.querySelectorAll(seletor).forEach(elemento => {
        elemento.remove()
    })
    tarefas = somenteConpletas ? tarefas.filter(tarefa => !tarefa.completa) : []
    atualizarTarefas()
}
